...
import { elementChildren } from '../../utilities/components.tsx.esnext';
...
function ButtonGroup({
  ...
  const contents = elementChildren(children).map((child, index) => /*#__PURE__*/React$1.createElement(Item$1, {
    button: child,
    key: index
  }));
